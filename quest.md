...
Submit a PR here: https://github.com/0rbit-co/quest with the Name=`price-feed-bot-${tobyblac}` and with the codebase and demo link in the description.
...
Submit a PR here: https://github.com/0rbit-co/quest with the Name=`news-feed-bot-${tobyblac}` and with the codebase and demo link in the description.
